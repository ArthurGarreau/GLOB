...
input_file = DATA_PATH / f"GLOB_data_{f}min_2025.nc"
output_file_path = SCRIPT_PATH / "GLOB_data" / "B_and_D_Estimations_NYA" 
...
for date in dates: 
    ...
    TIMESTAMPS = pd.date_range(start=f"{date} 00:00:00", end=f"{date} 23:59:00", freq=f'{f}min', tz='UTC')
